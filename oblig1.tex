...
\oppgave{1c}
For $z=8i$ har vi $|z| = r = 8$, $\sqrt[3]{r} = (2^3)^\frac{1}{3} = 2$ og
$\text{Arg }z = \theta = \arctan{8} \approx 0.139$ som gir
\begin{equation*}
\begin{split}
...
\begin{equation*}
\begin{split}
  k=0 \text{ gir } w_0 = 1.997 + 0.092i \\
  k=1 \text{ gir } w_1 = -1.078 + 1.683i \\
  k=2 \text{ gir } w_2 = -0.918 - 1.776i \\
\end{split}
\end{equation*}
Plott i figur \vref{plot.1c}.
